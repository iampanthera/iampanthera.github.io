...
const socialMediaLinks = {
  github: "https://github.com/iampanthera",
  linkedin: "https://www.linkedin.com/in/miantalha/",
  gmail: "miantalhaakram@gmail.com",
  // gitlab: "https://gitlab.com/saadpasta",
  // facebook: "https://www.facebook.com/saad.pasta7",
  medium: "https://medium.com/@miantalhaakram",
  stackoverflow: "https://stackoverflow.com/users/13786766/mian-talha",
  ...
  experience: [
    {
      ...
      descBullets: [
        ...
        "Applied object-oriented programming principles, resulting in a 15% increase in code maintainability.",
        "Collaborated in Agile sprints, leading to a 20% increase in project delivery efficiency.",
        "Utilized React, Angular, and Vue.js to create dynamic and responsive interfaces, reducing processing time by 30%.",
        "Implemented Docker and Kubernetes for efficient scaling and deployment, reducing deployment time by 40%.",
        "Integrated Stripe and AWS S3 through RESTful APIs and web hooks for payment processing, file storage, and SMS messaging.",
        "Spearheaded a pricing restructure, focusing on consumer willingnessto pay and implementing a three-tiered model.Resulted in a 35% increase in average sale and a 12% boost in margin"
      ]
    },
    {
...
const contactInfo = {
  ...
  number: "+92-3161470486",
  email_address: "miantalhaakram@gmail.com"
};

// Twitter Section

const twitterDetails = {
  userName: "MianTal34179148", //Replace "twitter" with your twitter username without @
  display: true // Set true to display this section, defaults to false
};
